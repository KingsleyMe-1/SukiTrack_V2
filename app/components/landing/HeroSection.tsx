...
const floatingBadges = [
  {
    ...
    content: (
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div>
          <p className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-foreground/60">Monthly Growth</p>
          <p className="text-lg md:text-xl font-extrabold text-foreground tracking-tight">+24.8%</p>
        </div>
      </div>
    ),
    style: {},
  },
  {
    ...
    content: (
      <div className="flex items-center gap-3 md:gap-4">
        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-chart-3/20 flex items-center justify-center text-chart-3 shrink-0">
          <span className="material-symbols-outlined text-xl md:text-2xl">account_balance_wallet</span>
        </div>
        <div>
          <p className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-foreground/60">Today&apos;s Sales</p>
          <p className="text-lg md:text-xl font-extrabold text-foreground tracking-tight">₱4,820.00</p>
        </div>
      </div>
    ),
    ...
    <section className="relative px-6 md:px-8 py-14 md:py-24 max-w-7xl mx-auto overflow-visible">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 relative animate-fade-in-up animation-delay-200 mx-auto w-full max-w-md lg:max-w-none">
          <div className="relative rounded-[2.5rem] overflow-hidden aspect-square shadow-2xl bg-secondary border-4 border-white/50 dark:border-white/5">
            <Image
          ...
          <GlassCard className="absolute top-1/2 -right-10 md:-right-12 px-5 py-3 rounded-full shadow-xl flex items-center gap-3 -translate-y-1/2 z-10 hover:translate-x-2 transition-transform cursor-default">
            ...
            <p className="text-xs md:text-sm font-bold text-foreground tracking-tight whitespace-nowrap">Low Stock Alert</p>
          </GlassCard>
          ...
          <GlassCard className="absolute top-10 md:top-12 -left-8 md:-left-10 px-5 py-3 rounded-full shadow-xl flex items-center gap-3 z-10">
            ...
            <span className="text-[9px] md:text-[10px] font-bold text-foreground uppercase tracking-[0.2em] whitespace-nowrap">Live Updates</span>
          </GlassCard>
          ...
          <GlassCard className="absolute bottom-16 md:bottom-20 -right-10 md:-right-14 p-4 md:p-5 rounded-2xl shadow-2xl flex flex-col items-start gap-1 z-10 animate-bounce-slow">
            <p className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-foreground/60">Listahan Balance</p>
          ...
          <GlassCard className="absolute top-2/3 -left-10 md:-left-14 p-3 md:p-4 rounded-2xl shadow-2xl flex items-center gap-3 z-10 hover:-translate-x-2 transition-transform cursor-default">
            ...
            <div>
              <p className="text-[9px] md:text-[10px] font-bold uppercase text-foreground/50 tracking-wider">Nearby Store</p>
              <p className="text-xs md:text-sm font-extrabold text-foreground whitespace-nowrap">Aling Nenas</p>
            </div>
          </GlassCard>
        </div>
      </div>
