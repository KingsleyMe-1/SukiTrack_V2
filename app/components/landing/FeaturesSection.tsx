    ...
    <section id="pricing" className="py-20 md:py-28 px-6 md:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 mb-12 md:mb-14">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-foreground tracking-tight leading-[1.1]">
            Every tool you need,
            <br />
            <span className="text-foreground/35">nothing you don&apos;t.</span>
          </h2>
        </div>
        <p className="text-sm text-muted-foreground font-medium max-w-xs leading-relaxed md:text-right shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
        ...
        <div className="md:col-span-2 bg-secondary rounded-3xl p-7 md:p-9 flex flex-col overflow-hidden group border border-border/50 hover:border-primary/20 transition-all duration-300">
          <div className="flex items-start justify-between mb-4">
            <span className="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] uppercase text-foreground/30">
          ...
          <p className="text-sm text-muted-foreground font-medium leading-relaxed max-w-sm mb-6">
            Track every &ldquo;utang&rdquo; digitally. Automated SMS reminders collect
            payments &mdash; no awkward conversations needed.
          </p>
          <div className="relative mt-auto rounded-2xl overflow-hidden ring-1 ring-border">
            <Image
            ...
            <div className="absolute bottom-3 left-3 flex items-center gap-2 bg-secondary/90 backdrop-blur-sm rounded-xl px-3 py-2 shadow-sm">
        ...
        <div className="bg-secondary rounded-3xl p-7 md:p-9 flex flex-col group border border-border/50 hover:border-primary/20 transition-all duration-300">
        ...
        <div className="bg-secondary rounded-3xl p-7 md:p-9 flex flex-col group border border-border/50 hover:border-chart-3/25 transition-all duration-300">
          <div className="flex items-start justify-between mb-6">
            <span className="inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] uppercase text-foreground/30">
              <span className="w-4 h-px bg-foreground/20 inline-block" />
              04 &middot; Analytics
            </span>
              <div className="w-8 h-8 rounded-xl bg-chart-3/20 text-chart-3 flex items-center justify-center shrink-0">
          ...
          <div className="mb-4">
            <p className="text-2xl font-extrabold text-foreground tracking-tight leading-none">+24.8%</p>
            <p className="text-xs text-muted-foreground font-medium mt-1">avg. monthly margin growth</p>
          </div>
