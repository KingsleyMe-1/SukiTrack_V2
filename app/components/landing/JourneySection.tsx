...
export function JourneySection() {
  return (
    <section id="features" className="py-20 md:py-28 bg-surface-container-low/50">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-xl mx-auto mb-14 md:mb-18 animate-fade-in-up">
          <h2 className="text-3xl md:text-4xl font-extrabold text-on-surface mb-4 tracking-tight">
            Choose your journey
          </h2>
            ...
            <div
              ...
              className={`p-10 md:p-12 rounded-[3rem] transition-all group cursor-pointer flex flex-col items-start ${
                card.dark
                  ...
                  : "bg-surface-container-lowest shadow-sm hover:shadow-2xl hover:shadow-primary/5 border border-outline-variant/10 hover:border-primary/30"
              }`}
            >
              <div
                className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-8 md:mb-10 shadow-sm group-hover:scale-110 transition-all duration-500 ${
                  card.dark
                    ...
                    : "bg-surface-container-low text-primary group-hover:bg-primary/8"
                }`}
              >
              ...
              <p
                className={`mb-8 md:mb-10 leading-relaxed text-sm md:text-base font-medium opacity-80 ${
                  card.dark ? "text-emphasis-on-surface" : "text-on-surface-variant"
                }`}
              >
                {card.description}
              </p>
